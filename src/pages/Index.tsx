        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-slide-up">
              Isi ulang diamond, crystal, dan voucher game favorit kamu dengan
              harga termurah. Proses instan, pembayaran mudah, 100% aman.
            </p>
            ...
            {[
              {
                ...
                title: "Proses Instan",
                description:
                  "Top up langsung masuk ke akun game kamu dalam hitungan detik.",
              },
              {
                icon: Shield,
                title: "100% Aman",
                description:
                  "Transaksi terenkripsi dan data kamu terlindungi dengan baik.",
              },
              {
                icon: Clock,
                title: "Layanan 24/7",
                description:
                  "Customer service siap membantu kapanpun kamu butuhkan.",
              },
            ].map((feature, index) => (
